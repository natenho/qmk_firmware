...
*/
 [_FN1_LAYER] = KEYMAP( /* Base */
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_CALCULATOR, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS, KC_DEL, KC_TRNS,
...
* | Esc     |LEFT |DOWN |RIGHT|  f  |  g  |  h  |  j  |  k  |  l  | PGUP|PGDN |    Enter    |
* |-----------------------------------------------------------------------------------------+
* | Shift      |V-UP |V-DWN|MUTE |  v  |  b  |  n  |  m  |PREV_TRACK|NEXT_TRACK| DEL |Shift |
* |-----------------------------------------------------------------------------------------+
...
*/
 [_FN2_LAYER] = KEYMAP( /* Base */
    ...
    MO(_FN2_LAYER), KC_TRNS, KC_UP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PAUSE, KC_HOME, KC_END, KC_TRNS,
    KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_PGDN, KC_TRNS,
    KC_TRNS, KC_VOLU, KC_VOLD, KC_MUTE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK, KC_TRNS, KC_TRNS,
...
layer_state_t layer_state_set_user(layer_state_t layer) {
  switch(get_highest_layer(layer)) {
    case _FN1_LAYER:
      ...
      annepro2LedSetForegroundColor(0x9A, 0xCD, 0x55);
      break;
    case _FN2_LAYER:
      // Set the leds to blue
      annepro2LedSetForegroundColor(0x5F, 0x9E, 0xA0);
      break;
    default:
